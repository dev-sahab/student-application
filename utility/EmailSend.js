...
const verficationMailSend = async (to, sub, data = { }) => {
    ...
    await transport.sendMail({
        from : `Account Verification <${process.env.EMAIL_HOST}>`,
        to : to,
        subject : sub,
        html : `
        <!DOCTYPE html>
        ...
        <body>
            ...
            <div class="main-wrapper">
                <div class="wrapper">
                    ...
                    <hr color="#dedede" >
                    <div class="message">
                        <h4 style="margin-bottom: 15px">Hi ${data.name},</h4>
                        <p>To activate your Account, please verify your email address.</p>
                    </div>
                    <div class="verify-btn">
                        <a href="${host_url}/student/verify/${data.token}">Verify Your Email</a>
                    </div>
                    <div class="follow">
                ...
                <div class="footer">
                    <p>This system email was sent to ${data.name} (${data.mail}) regarding your Student App Account</p>
                    <p class="copyright">&copy; copyright ${present_year}. All Right Reserved by <a href="https://shb-services.com"><strong>SHB-Services</strong></a></p>
                </div>
            </div>
...
// export
module.exports = verficationMailSend